...
hdlr = logging.FileHandler(os.path.join(cur_path, 'bi_antifraud3.log'))
...
output_stream = os.path.relpath('..\\paymo_output\\bi_output3.txt', cur_path)
...
with open(output_stream, 'w') as fout:
    with open(input_stream, 'r') as fin:
        for line in fin:
            ...
            i += 1
            fout.write(bi_feature_3(connections, user_1, user_2) + "\n")
